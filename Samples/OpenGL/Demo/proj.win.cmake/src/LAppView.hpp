...
private:
	...
	LAppSprite* _moveicon;                   ///< moveicon image
	LAppSprite* _H_inc;                      ///< height inc
	LAppSprite* _H_dec;                      ///< height dec
	LAppSprite* _W_inc;                      ///< width inc
	LAppSprite* _W_dec;                      ///< width dec
	LAppSprite* _people;                     ///< people
	...
	bool _isMoving;                  ///< check whether moveicon is pushed
	int _moveicon_dx;                ///< set the relitive position of cursor when pushing moveicon
	int _moveicon_dy;				 ///< set the relitive position of cursor when pushing moveicon
	bool _lockButton;                ///< lock all the button
};
